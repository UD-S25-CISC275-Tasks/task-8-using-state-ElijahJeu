...
export function CycleHoliday(): React.JSX.Element {
   ...
   const holidaysWithEmojis: { [key: string]: string } = {
    ...
    const Alphabet: string[] = ["Christmas","Easter","Halloween","New Year's Day","Thanksgiving"] 
    const dates: string[] = ["New Year's Day", "Easter", "Halloween", "Thanksgiving", "Christmas"];
   ...
   function advanceDate(): void{
    ...
    return (<div>
            <h3>Holiday: {holidaysWithEmojis[holiday]} {holiday}</h3>
